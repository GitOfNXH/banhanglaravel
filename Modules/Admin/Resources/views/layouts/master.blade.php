...
<head>
    ...
    <!-- //bootstrap-css -->
    <!-- Custom CSS -->
    <link href="{{asset('theme_admin/css/style.cs') }}s" rel='stylesheet' type='text/css' />
    ...
    <script src="{{asset('theme_admin/js/raphael-min.js') }}"></script>
    <script src="{{asset('theme_admin/js/morris.js') }}"></script>
